                    ...
                    <div class="col-xl-4 col-md-6 col-lg-4">
                        <div class="single_department">
                            <div class="department_thumb">
                                <a href="{{url('/')}}/episode/{{$epis->id}}">
                                    <img src="{{URL::asset('Thumbnails_series_file/'.$epis->thumbnail)}}" alt="">
                                </a>

                            </div>
                            <div class="department_content">
                                <h3><a href="#">{{$epis->description}}</a></h3>
                                <p>{{$epis->Series->title}}: {{$epis->title}}</p>
                                <a href="{{url('/')}}/episode/{{$epis->id}}" class="learn_more">Show</a>
                            </div>
                        </div>
                    </div>
                @endforeach
